...
description: >-
  Polygon marketplace for tokenized sports collectibles with indexed NFT data,
  auctions, and WalletConnect.
achievements:
  - 'Built an NFT indexer with Moralis streams, Node.js, and PostgreSQL on Google Cloud.'
