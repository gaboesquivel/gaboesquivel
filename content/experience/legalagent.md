...
duration: '2025'
description: >-
  AI legal platform with voice, chat, and retrieval for case context, documents,
  and procedures.
achievements:
  ...
  - Sat with the firm's attorneys on how they used the assistant, then adjusted persona and tool calling from that feedback.
techStack:
  - TypeScript
  - React Native
  - Expo
