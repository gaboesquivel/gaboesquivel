...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: 'bitcashbank',
    description:
      "Bitcash allows users to buy, trade, deposit, and earn on cryptocurrencies, with a focus on exchanging funds for local currency stablecoins or bitUSD. The platform also features BitcashDAO for community-based decision-making.\n At Bitcash, my role from the start focused on infrastructure design, tech recruitment, and developer training. I later transitioned to a consulting role to guide the platform's continuous adaptation and success.",
    tech: [
      'Antelope',
      'C++',
      'ReactJS',
  ...
  },
  {
    ...
    slug: 'wizard-world',
    description:
      "A progressive web app connects to OpenAI's LLM models to generate AI images and mint them on the Flow blockchain. This app integrates AI with blockchain technology.\n My role involved the app's development, focusing on integrating OpenAI's models for image generation and ensuring smooth functionality with the Flow blockchain.",
    tech: [
      'NextJS',
      'ReactJS',
      'Flow',
  ...
  },
  {
    ...
    description:
      "Jockey Hollow Bar and Kitchen, located in a historic mansion, features four distinct dining concepts. The responsive landing page I developed introduces visitors to its diverse culinary world.\n My work focused on developing the main responsive landing page, ensuring an inviting and informative digital gateway to the restaurant's offerings.",
    tech: [
      'SASS',
      'jQuery',
      'Lodash',
  ...
  },
  {
    ...
    slug: 'tractor-supply',
    description:
      "The Tractor Supply mobile app offers features like product browsing, exclusive offers, account management, and an augmented reality feature for product previews.\n As a consultant, I enhanced the app's performance and code quality, and developed its augmented reality feature, improving user experience and engagement.",
    tech: [
      'React Native',
      'ReactJS',
      'NodeJS',
  ...
  },
  {
    ...
    slug: 'gridium',
    description:
      'Gridium is an energy data analytics prototype for visualizing and analyzing energy consumption. It aids in informed energy management decisions.\n I built the first version of the application, focusing on displaying data collected from various buildings.',
